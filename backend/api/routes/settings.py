...
API_KEY_DEFINITIONS = [
    ...
    {"key": "api_naver_datalab_id", "label": "네이버 데이터랩 Client ID", "env_var": "NAVER_CLIENT_ID",
     "description": "데이터랩 쇼핑인사이트 API 인증용", "prefix": ""},
    {"key": "api_naver_datalab_secret", "label": "네이버 데이터랩 Client Secret", "env_var": "NAVER_CLIENT_SECRET",
