...
def init_db():
    ...
    if _pt_n == 0:
        _prompts = [
            ...
            ("story", "reels_script", "릴스 스크립트", '릴스 애니메이션 스크립트를 JSON으로 생성하세요.\n\n설정:\n- 주인공: 30대 후반 경영학과 출신 부사장, 코딩 제로 → Claude로 AI 개발\n- Pixar 3D 애니메이션 스타일, 35~45초, 7개 장면\n- 각 장면: id, start, end, image, motion, subtitle, tts_text, image_prompt, motion_prompt\n- 마지막 장면은 반전 또는 유머\n- threads_text: 같은 이야기를 200~400자 텍스트로\n\n소재: {source_data}\n에피소드: {episode_num}\n\nJSON만 출력:'),
            ("image", "character_vp", "VP 캐릭터 마스터", 'A Pixar-style 3D animated character: Korean man in his late 30s, short neat dark hair, black horn-rimmed glasses, slim fit light blue dress shirt with rolled-up sleeves, dark navy chino pants, no tie. Slightly thin build, warm friendly face with expressive eyes. Clean minimal office background. Soft studio lighting, Pixar/Disney animation quality, 4K render.'),
            ("image", "character_logistics", "물류 담당자", 'Pixar-style 3D character: Korean man in his 50s, slightly stocky build, short gray-streaked hair, wearing a navy work vest over polo shirt. Arms crossed, skeptical expression. Same minimal office background. Pixar quality, 4K.'),
            ("image", "character_accountant", "경리", 'Pixar-style 3D character: Korean woman in her 40s, neat bob haircut, reading glasses on nose tip, holding a calculator, wearing a cream cardigan over white blouse. Precise and organized appearance. Same office background. Pixar quality, 4K.'),
            ("image", "character_junior", "영업 막내", 'Pixar-style 3D character: Korean man in his early 20s, slightly messy hair, wireless earbuds, casual hoodie under blazer, energetic expression, holding smartphone. Same office background. Pixar quality, 4K.'),
            ("image", "scene_default", "장면 기본 템플릿", '@{character} {action}, Pixar style, {lighting}, 9:16 aspect ratio, 4K render'),
            ("video", "motion_default", "기본 모션", 'subtle breathing motion, slight head movement, natural idle animation, Pixar style'),
