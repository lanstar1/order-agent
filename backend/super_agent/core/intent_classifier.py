...
- client_analysis: 거래처 분석, 거래처 건강도, 이탈 탐지, RFM 분석, 영업 전략
- market_research: 시장 조사, 경쟁사 분석, 트렌드, 시장 동향
- meeting_prep: 미팅 자료, 브리핑, 프레젠테이션, 발표 준비
- content_creation: 콘텐츠 생성, 블로그, 상세페이지, 마케팅 자료, 카피
- inventory_analysis: 재고 분석, 발주 참고, 품절 위험, ABC 분석, 수요 예측
- pricing_analysis: 가격 분석, 마진, 채널별 가격, 수익성, 가격 전략
- product_mix: 상품 믹스, SKU 분석, 제품 포트폴리오, BCG 매트릭스
- b2c_channel: B2C 채널, 쿠팡, 네이버, 온라인몰, 광고 ROI
- cs_analysis: CS 분석, 반품, 불량, 고객 불만, VOC, 클레임
- manufacturer_comm: 제조사 보고, 공급사 커뮤니케이션, 실적 리포트
- certification: 인증 관리, 규격, KC, CE, 인증서 만료
- sales_coaching: 영업 코칭, 제안서, 영업 스크립트, 파이프라인
- executive_report: 경영 보고서, 임원 보고, 월간 브리핑, KPI 대시보드
- automation: 업무 자동화, 프로세스 개선, 효율화
