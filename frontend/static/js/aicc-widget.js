...
(function () {
  ...
  #ls-chat-popup{position:fixed;bottom:90px;right:264px;z-index:99999;width:380px;height:600px;border-radius:16px;background:#fff;box-shadow:0 8px 40px rgba(0,0,0,.22);display:none;flex-direction:column;overflow:hidden;font-family:'Noto Sans KR',sans-serif}
